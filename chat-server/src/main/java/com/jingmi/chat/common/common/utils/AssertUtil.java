...
public class AssertUtil {
    ...
    public static void isTrue(boolean expression, CommonErrorEnum errorEnum, Object... args) {
        if (!expression) {
    ...
    //如果是true，则抛异常
    public static void isFalse(boolean expression, CommonErrorEnum errorEnum, Object... args) {
        if (expression) {
            throwException(errorEnum, args);
        }
    }
    ...
    //如果不是非空对象，则抛异常
    public static void isNotEmpty(Object obj, CommonErrorEnum errorEnum, Object... args) {
        if (isEmpty(obj)) {
            throwException(errorEnum, args);
        }
    }
    ...
    private static void throwException(CommonErrorEnum errorEnum, Object... arg) {
        if (Objects.isNull(errorEnum)) {
            errorEnum = CommonErrorEnum.BUSINESS_ERROR;
        }
        throw new BusinessException(errorEnum.getCode(), MessageFormat.format(errorEnum.getMessage(), arg));
    }
