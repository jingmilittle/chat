...
public class MPGenerator {
    public static void main(String[] args) {
       ...
       // globalConfig.setOutputDir(System.getProperty("user.dir") + "/mallchat-chat-server/src/main/java");
        ...
        //设置作者名字
        globalConfig.setAuthor("<a href=\"https://github.com/jingmilittle\">jingmi</a>");
        ...
        packageConfig.setParent("com.jingmi.chat.common.user");//自定义包的路径
...
//        strategyConfig.setTableFillList(list);
    ...
    public static void assembleDev(DataSourceConfig dataSourceConfig) {
        ...
        dataSourceConfig.setPassword("1314520@aoligeiniema");
        dataSourceConfig.setUrl("jdbc:mysql://124.220.236.171:4479/mallchat?useUnicode=true&characterEncoding=utf-8&useSSL=true&serverTimezone=UTC");
    }
}
